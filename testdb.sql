...
CREATE TABLE `apn` (
  ...
  `apn` char(19) DEFAULT NULL,
  `rec_num` int(6) unsigned DEFAULT NULL
...
INSERT INTO `version` VALUES ('apn',10),('ses',1);
...
-- Dump completed on 2016-03-15  9:35:29
